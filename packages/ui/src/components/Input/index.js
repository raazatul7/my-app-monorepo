...
// Input component
export const Input = ({ label, placeholder, type = 'text', size = 'medium', state = 'default', error, helperText, leftIcon, rightIcon, containerStyle, inputStyle, labelStyle, errorStyle, helperStyle, onFocus, onBlur, ...props }) => {
